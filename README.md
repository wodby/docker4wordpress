...
Check out <a href="https://wodby.com" target="_blank">Wodby</a> if you need optimized consistent docker-based environment for WordPress on your dev/staging or production servers. 
