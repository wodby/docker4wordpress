# Running Multiple Projects with Docker4WordPress
...
3. Download `traefik.yml` from docker4wordpress repository, replace example network names to your own (e.g. `projectdir_default` instead of `project1-dir_default`)
